...
public final class ApiDtos { private ApiDtos(){}
 ...
 public record TransactionView(Long id,String cardNumber,String merchant,BigDecimal amount,TransactionType transactionType,TransactionStatus status,String failureReason,LocalDateTime transactionDate){}
